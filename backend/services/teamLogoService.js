/**
 * Team Logo Service
 * Provides URLs for NBA team logos
 */

// NBA team abbreviations to logo URL mapping
// Using NBA.com CDN for team logos
const TEAM_LOGOS = {
...
export function getTeamName(teamAbbrev) {
  ...
  const abbrev = teamAbbrev?.toUpperCase().trim();
  return teamNames[abbrev] || teamAbbrev || 'Unknown Team';
}
